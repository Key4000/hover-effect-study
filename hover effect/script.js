...
//Массив эл-ов по которому будем ходить 
...
function menuEffect()
{
    ...
    function menuLinkActions(e){
        ...
        const menuPosInf =  menuLink.getBoundingClientRect();
    
        const menuTop = menuPosInf.top;
        const menuLinkPos = e.pageY - (menuTop + scrollY);
